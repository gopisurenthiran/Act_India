  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full px-2 sm:px-6 lg:px-12">
        <div className="max-w-4xl text-left md:text-left text-center md:text-left mt-16">
          <motion.div
            ...
            className="
    absolute 
    bottom-24 right-6        /* mobile slightly higher */
    md:bottom-32 md:right-12 /* desktop slightly higher */
  "
          >
            <Link
              to="/contact"
