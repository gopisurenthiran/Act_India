        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end">
            <div className="text-left">
              ...
              <span className="block w-16 border-b-2 border-white mx-auto lg:mx-0 mb-4 mt-4" />
                ...
                {visible.map((dealer) => (
                  <motion.div
                    ...
                    className="bg-white text-black shadow-lg
                               ...
                               w-80 h-[400px] p-6 text-left"
                  >
                    <motion.img src={dealer.img} alt={dealer.product} className="h-32 object-contain"
                      whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }} loading="lazy" decoding="async" />

                    <div>
                      <img src={dealer.name} alt={dealer.product} className="h-12 object-contain" loading="lazy" decoding="async" />
                    </div>

                    <span className="bg-gradient-primary font-primary text-white px-4 py-1 rounded-md text-lg font-bold">
                      {dealer.product}
                    </span>

                    {/* Per-slide route link */}
                    <MotionLink
                      to={dealer.link}
                      whileHover={{ x: 5 }}
