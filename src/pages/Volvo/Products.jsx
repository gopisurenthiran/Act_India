...
const ITEMS = [
  // Products
  {
    ...
    gallery: [
      "/assets/popup-slide-1.png",
      "/assets/popup-slide-2.png",
    ],
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-black/80 text-white text-xl leading-none hover:bg-black focus:outline-none"
        >
          ×
        </button>
        ...
        >
          ...
          {images.length > 1 && (
            <>
              <button
                onClick={goPrev}
                className="absolute left-3 top-1/2 -translate-y-1/2 bg-black/70 text-white h-10 w-10 rounded-full grid place-items-center hover:bg-black"
              >
                ‹
              </button>
              <button
                onClick={goNext}
                className="absolute right-3 top-1/2 -translate-y-1/2 bg-black/70 text-white h-10 w-10 rounded-full grid place-items-center hover:bg-black"
              >
                ›
              </button>
            </>
